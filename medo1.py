#!/usr/bin/python2
#coding=utf-8
#This Script Is Written By Mr.unknown
...
█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
\033[1;97m⊱• ────────────  ──────────── •⊰
\033[1;96m≫ \033[1;96m RECODDED BY :\033[1;95m mr.unknown
\033[1;96m≫ \033[1;96m FACEBOOK:\033[1;95m Medoriya Smith
\033[1;96m≫ \033[1;96m youtube :\033[1;95m Mr unknown
...
\033[1;96m≫ \033[1;96m NOTE :\033[1;95m Contact me on fb mr.unknown
...
print """
\033[1;32m ╔════•ೋೋ•════╗ 
\033[1;97m  recoded•••   •••by mr.unknown
\033[1;32m ╚════•ೋೋ•════╝"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;32mACCESS GRANTED AS " + username #Dev:Mr.unknown
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;31mACCESS DENIED"
            os.system('xdg-open https://www.facebook.com/medoriya.smith.9803')
    else:
        print "\033[1;31mACCESS DENIED"
        os.system('xdg-open https://www.facebook.com/medoriya.smith.9803')
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:mr.unknown
	print logo
	...
	print "\033[1;93manonyphinx[ philippines ]"
...
──▄████▄──▐▌──▄████▄─"""
	...
	p.map(main, id)
	print "\033[1;32m⊱• ──────────── ──────────── ──────────── •⊰"
	print "  \033[1;93m⊱•─── Recoded by mr.unknow ─── •⊰" #Dev:mr.unknown
...
Checkpoint ID Open After 7 Days
 contact Me :on facebook page mr.unknown"""
